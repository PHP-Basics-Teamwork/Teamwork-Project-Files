    ...
    <section>
        ...
        <div id="aboutUser">
            <ul>
                ...
                <li><span class="profile-label">Personal Text: </span> Some txt</li>
                <li><span class="profile-label">Gender: </span> Male</li>
                <li><span class="profile-label">Age:</span> 101</li>
                <li><span class="profile-label">Date Registered: </span> September 25, 2008, 09:00:42 PM</li>
                <li><span class="profile-label">Local Time:</span> August 21, 2014, 06:06:41 AM</li>
                <li><span class="profile-label">Last Active: </span> July 07, 2014, 03:16:56 AM</li>
            </ul>
            <h6>Signature:</h6>
            <p id="signature">
